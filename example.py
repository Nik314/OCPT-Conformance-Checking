...
if __name__ == "__main__":
    ...
    for i in range(len(events)):
        ...
        for object in events[i][1]:
            relations.loc[relations.shape[0]] = (timestamp + i*datetime.timedelta(seconds=i)), str(i), activity, object.split("_")[1], object.split("_")[0]
    ...
    eocpt = OperatorNode(("i","o"),subtrees=[OperatorNode(("o","c"),subtrees=[ocpt])])
    ...
    determine_conformance(eocpt.subtrees[0],relations,10)
    determine_conformance(eocpt,relations,10)
