...
from liss.localocpa.objects.log.importer.ocel.versions import import_ocel_json
from liss.localocpa.objects.log.importer.ocel.versions import import_ocel_xml
