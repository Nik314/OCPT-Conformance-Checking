...
from liss.localocpa.objects.log.importer.ocel import factory as ocel_import_factory
from liss.localocpa.algo.discovery.ocpn import algorithm as ocpn_discovery_factory
from liss.localocpa.visualization.oc_petri_net import factory as ocpn_vis_factory

from liss.localocpa.objects.oc_petri_net.obj import ObjectCentricPetriNet, Marking
from liss.localocpa.objects.log.ocel import OCEL

from liss.processexecutiongraph import OCEvent, ProcessExecutionGraph
from liss.alignment import Alignment, Move, UndefinedModelMove, DefinedModelMove, LogMove, SynchronousMove, \
...
def preprocessing_dejure_net(ocel: OCEL, indirect_id, ocpn):
    ...
    for transition in original_transitions:
        ...
        liss.helperfunctions.remove_transition_and_connected_arcs(transition, ocpn)
